 ...
 */
public class CustomPopup extends QMUIBasePopup {
    ...
    public CustomPopup(Context context, int preferredDirection) {
        super(context);
    ...
    public class ViewHolder implements View.OnClickListener{
        ...
        @BindView(com.xiaomo.travelhelper.R.id.popup_add_friend_layout) LinearLayout addFriendLayout;
        @BindView(com.xiaomo.travelhelper.R.id.popup_chat_layout)LinearLayout chatLayout;

        @Override
        public void onClick(View v) {
            if(mItemClickCallback != null){
                mItemClickCallback.itemClick(v);
                dismiss();
            }
        }
    }
