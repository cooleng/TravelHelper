...
import com.xiaomo.travelhelper.baidu.BikingRouteOverlay;
import com.xiaomo.travelhelper.baidu.DrivingRouteOverlay;
import com.xiaomo.travelhelper.baidu.MassTransitRouteOverlay;
import com.xiaomo.travelhelper.baidu.OverlayManager;
import com.xiaomo.travelhelper.baidu.RouteLineAdapter;
import com.xiaomo.travelhelper.baidu.TransitRouteOverlay;
...
public class RoutePlanActivity extends AppCompatActivity implements BaiduMap.OnMapClickListener,
    ...
    @BindView(R.id.pre) Button mBtnPre; // 上一个节点
    @BindView(R.id.next) Button mBtnNext; // 下一个节点
    @BindView(R.id.map) MapView mMapView;
    @BindView(R.id.route_plan_city_st_et) EditText mCityStartEt;
    @BindView(R.id.route_plan_detail_st_et) EditText mDetailStartEt;
    @BindView(R.id.route_plan_city_end_et) EditText mCityEndEt;
    @BindView(R.id.route_plan_detail_end_et) EditText mDetailEndEt;
    @BindView(R.id.mass) Button mMassBtn;
    @BindView(R.id.drive) Button mDriveBtn;
    @BindView(R.id.transit) Button mTransitBtn;
    @BindView(R.id.walk) Button mWalkBtn;
    @BindView(R.id.bike) Button mBikeBtn;
    ...
    public void backLayoutClick(View v){
        finish();
    }
    ...
    public void searchButtonProcess(View v) {
        ...
        mBaidumap.clear();
        // 获取起点终点
        String startCity = mCityStartEt.getText().toString();
        String endCity = mCityEndEt.getText().toString();
        String startDetail = mDetailStartEt.getText().toString();
        String endDetail = mDetailEndEt.getText().toString();

        if(TextUtils.isEmpty(startCity) || TextUtils.isEmpty(endCity)){
            Toast.makeText(RoutePlanActivity.this,"请输入城市",Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(startDetail) || TextUtils.isEmpty(endDetail)){
            Toast.makeText(RoutePlanActivity.this,"请输入详请点",Toast.LENGTH_SHORT).show();
        }else{
            ...
            if (v.getId() == R.id.mass) {
                ...
                nowSearchType = 0;
                mMassBtn.setTextColor(getResources().getColor(R.color.blue));
                mDriveBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mWalkBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mTransitBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mBikeBtn.setTextColor(getResources().getColor(R.color.grey_2));
            } else if (v.getId() == R.id.drive) {
                mSearch.drivingSearch((new DrivingRoutePlanOption())
                        .from(stNode).to(enNode));
                nowSearchType = 1;
                mMassBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mDriveBtn.setTextColor(getResources().getColor(R.color.blue));
                mWalkBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mTransitBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mBikeBtn.setTextColor(getResources().getColor(R.color.grey_2));
            } else if (v.getId() == R.id.transit) {
                mSearch.transitSearch((new TransitRoutePlanOption())
                        .from(stNode).city(startCity).to(enNode));
                nowSearchType = 2;
                mMassBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mDriveBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mWalkBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mTransitBtn.setTextColor(getResources().getColor(R.color.blue));
                mBikeBtn.setTextColor(getResources().getColor(R.color.grey_2));
                ...
                mMassBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mDriveBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mWalkBtn.setTextColor(getResources().getColor(R.color.blue));
                mTransitBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mBikeBtn.setTextColor(getResources().getColor(R.color.grey_2));
                ...
                mWalkBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mTransitBtn.setTextColor(getResources().getColor(R.color.grey_2));
                mBikeBtn.setTextColor(getResources().getColor(R.color.blue));
            }
        }
    }
    ...
    public void nodeClick(View v) {
        ...
        popupText.setBackgroundResource(R.mipmap.popup_icon);
    ...
    class MyTransitDlg extends Dialog {
        ...
        public void setWidth(){
            ...
            lp.width = (int)(QMUIDisplayHelper.getScreenWidth(mContext)* 0.8); //设置宽度
