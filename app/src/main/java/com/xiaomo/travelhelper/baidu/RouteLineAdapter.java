 ...
 */
package com.xiaomo.travelhelper.baidu;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mtype) {
            ...
            case BIKING_ROUTE:
                ...
                holder.dis.setText("距离大约是：" + routeLines.get(position).getDistance()/1000.0 + "km");
                break;
            ...
            case MASS_TRANSIT_ROUTE:
                ...
                if(massTransitRouteLine.getPrice() > 0){
                    holder.dis.setText("总票价：" + massTransitRouteLine.getPrice() + "元");
                }else {
                    holder.dis.setText("总票价： 元");
                }
                break;
